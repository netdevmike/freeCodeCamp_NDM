const project_name = 'drum-machine';
...
class App extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("div", { className: "inner-logo " }, 'NDM' + String.fromCharCode(160)), /*#__PURE__*/
      React.createElement("i", { className: "inner-logo fas fa-music" })), /*#__PURE__*/
      ...
      React.createElement("input", { type: "range", min: "0", max: "1", step: "0.01", value: this.state.sliderVal, onChange: this.adjustVolume })), /*#__PURE__*/
